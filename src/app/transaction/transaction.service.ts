  ...
  getTransactions(filter: Filter): Observable<Transaction> {
    return Observable.create(observer => {
      ...
      observer.next({Transactions: {Transaction: [
          ...
          {TransactionID: 'TransactionID3', Status: 'Error', StartDateTime: 'StartDateTime2', EndDateTime: 'EndDateTime2',
            BusinessRefs: { BusinessRef: [{Name: 'BusinessRef4', Value: 'BusinessRef4Value'},
                {Name: 'BusinessRef35', Value: 'BusinessRef35Value'}, {Name: 'BusinessRef36', Value: 'BusinessRef36Value'}] } },
          {TransactionID: 'TransactionID3', Status: 'Error', StartDateTime: 'StartDateTime2', EndDateTime: 'EndDateTime2',
            BusinessRefs: { BusinessRef: [{Name: 'BusinessRef4', Value: 'BusinessRef4Value'},
                {Name: 'BusinessRef25', Value: 'BusinessRef25Value'}, {Name: 'BusinessRef26', Value: 'BusinessRef26Value'}] } },
          {TransactionID: 'TransactionID3', Status: 'Error', StartDateTime: 'StartDateTime2', EndDateTime: 'EndDateTime2',
            BusinessRefs: { BusinessRef: [{Name: 'BusinessRef4', Value: 'BusinessRef4Value'},
                {Name: 'BusinessRef15', Value: 'BusinessRef15Value'}, {Name: 'BusinessRef16', Value: 'BusinessRef16Value'}] } }
        ]}});
      observer.complete();
    });
  }
